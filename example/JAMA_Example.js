...
var MagicSquareExample = /** @class */ (function () {
   ...
   */
  /*private*/
  MagicSquareExample.print = function (s) {
    console.info(s);
  };
  /**
  ...
  MagicSquareExample.runExample = function (argv) {
    ...
    MagicSquareExample.print(
      "    See MagicSquareExample.runExample() for an explanation.\n"
    );
    MagicSquareExample.print(
    ...
    for (var n = 3; n <= 32; n++) {
      {
        MagicSquareExample.print(
          MagicSquareExample.fixedWidthIntegertoString(n, 7)
        );
        var M = MagicSquareExample.magic(n);
        var t = M.trace() | 0;
        MagicSquareExample.print(
          MagicSquareExample.fixedWidthIntegertoString(t, 10)
        );
        var E = new EigenvalueDecomposition(
          M.plus(M.transpose()).times$double(0.5)
        );
        var d = E.getRealEigenvalues();
        MagicSquareExample.print(
          MagicSquareExample.fixedWidthDoubletoString(d[n - 1], 14, 3)
        );
        var r = M.rank();
        MagicSquareExample.print(
          MagicSquareExample.fixedWidthIntegertoString(r, 7)
        );
        var c = M.cond();
        MagicSquareExample.print(
          c < 1 / eps
            ? MagicSquareExample.fixedWidthDoubletoString(c, 12, 3)
            : "         Inf"
        );
        ...
        MagicSquareExample.print(
          MagicSquareExample.fixedWidthDoubletoString(res, 12, 3)
        );
    ...
    MagicSquareExample.print(
      "\nElapsed Time = " +
        MagicSquareExample.fixedWidthDoubletoString(etime, 12, 3) +
        " seconds\n"
    );
